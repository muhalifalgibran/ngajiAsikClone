...
class LastMatchActivity : AppCompatActivity(), LastMatchView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.last_match)

        lastMatchList = findViewById<RecyclerView>(R.id.recyclerLastMatch).apply {
       ...
       // presenter = LastMatchPresenter(this,request,gson)
        ...
        swipeRefresh = findViewById<SwipeRefreshLayout>(R.id.swipe)
